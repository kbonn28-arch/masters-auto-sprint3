...
const MaintenanceClub = () => {
  ...
  const getSelectedPlanName = () => {
    return plans.find((plan) => plan.id === formData.plan)?.name || formData.plan;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const submission = {
      ...
      selected_plan: getSelectedPlanName(),
      vehicle_notes: formData.vehicleInfo,
      form_name: 'Maintenance Club Request',
      submitted_from: window.location.href
    };
    
    try {
      const response = await fetch('https://formspree.io/f/meepbqgd', {
        method: 'POST',
        headers: {
            ...
            <div className="card">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  >
                    {isSubmitting ? 'Submitting...' : 'Start Your Membership'}
